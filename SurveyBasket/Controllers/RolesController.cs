...
public class RolesController(IRoleService roleService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll([FromQuery] bool includeDisabeld , CancellationToken cancellationToken)
    {
        var roles = await _roleService.GetAllAsync(includeDisabeld , cancellationToken);
        return Ok(roles);
    }
